            ...
            <div className="ContactComponent-in">
                ...
                <div className="contact-two">
                    <div className="contact-two-one">
                        <Link href="mailto:2300033327cseh1@gmail.com"> <IoMdMail /> Send Email</Link>
                    </div>
                    <div className="contact-two-two">
                        <Link href="https://www.linkedin.com/in/sairekha/" target='_blank' aria-label="LinkedIn Profile"><FaLinkedin /></Link>
                        <Link href="https://github.com/nsairekha" target='_blank' aria-label="GitHub Profile"><FaGithub /></Link>
