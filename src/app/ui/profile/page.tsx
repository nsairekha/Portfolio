            ...
            <div className="ProfileComponent-in">
                <div className="profile-one">
                    ...
                    <div className="profile-one-three">
                        <Link href="https://drive.google.com/file/d/11nG7EOyHicoHxV9cuLgeCHvxvdydix9C/view?usp=sharing" target='_blank'> <RiExternalLinkLine /> Resume </Link>
                    </div>
                </div>
